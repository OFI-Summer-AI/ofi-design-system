...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-DXD6NAEX.js";
import {
  Portal
} from "./chunk-YJQMY64Q.js";
import "./chunk-BSDPHYDU.js";
import {
  DismissableLayer
} from "./chunk-FDQZKUOI.js";
import {
  Presence
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React4.useRef(false);
  const isPointerDownOnContentRef = React4.useRef(false);
  ...
  const handleDismiss = React4.useCallback(() => setOpen(false), [setOpen]);
  React4.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React4.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContent = React4.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React4.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
  ...
  const [containSelection, setContainSelection] = React4.useState(false);
  React4.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React4.forwardRef(
  (props, forwardedRef) => {
